...
class CartListXibTableView: UITableViewCell {
    ...
    private func assignRandomImage() {
        ...
        let imageNames = ["dummyStoreImage", "dummyStoreImage2", "dummyStoreImage3", "thirdProductImage", "secondProductImage", "firstProductImage"] // Replace these with your actual image names
